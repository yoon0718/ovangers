...
function Findpw_modal(props){
    ...
    return(
        <ReactModal isOpen={props.findpwSwitch} onRequestClose={() => {props.setFindPwSwitch(false); setMode(["check",""]);}} style={modal_style} ariaHideApp={false} >
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-x-lg" viewBox="0 0 16 16" onClick={() => {props.setFindPwSwitch(false); setMode(["check",""]);}}>
